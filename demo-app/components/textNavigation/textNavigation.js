...
Component({
  ...
  methods: {
    jumptap: function (e) {
      ...
      switch (linkData) {
        case 1:
          id = this.properties.textNavUrls.content.dataset[index].item_id;
          wx.navigateTo({
        ...
        case 5:
          ...
          var gameType = parseFloat(
            this.properties.textNavUrls.content.dataset[index].gameType
          );
          ...
          break;
        case 6:
          link = this.properties.textNavUrls.content.dataset[index].wxlink;
          wxltype = this.properties.textNavUrls.content.dataset[index]
            .wxlinkType;
          if (wxltype == 1) {
            wx.switchTab({
              url: "/" + link,
        ...
        case 10:
          ...
          break;
        case 11:
          link = this.properties.textNavUrls.content.dataset[index].link;
          if (link) {
            wx.navigateTo({
        ...
        case 14:
          id = this.properties.textNavUrls.content.dataset[index].item_id;
          wxlink = this.properties.textNavUrls.content.dataset[index].wxlink;
          wx.navigateTo({
            url: "/" + wxlink + "?id=" + id,
          });
          break;
