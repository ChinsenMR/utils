    ...
    if(imageResource && imageResource != ''){
      wx.downloadFile({
        ...
        success: (res) => {
          ...
          self.ctx.draw(false, () => {
            self.page.data.scratch.awardTxt = text
            console.log('抽奖d123', self.page)
            self.page.setData({
              scratch: self.page.data.scratch
            })
          })
        }
      })      
      ...
      self.ctx.draw(false,()=>{
        // self.page.scratch.awardTxt = text
        // console.log('抽奖d123', text)
        // self.page.setData({
        //   scratch: self.page.scratch
        // })
      })   
    }
  }
