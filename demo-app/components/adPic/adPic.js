Component({
  ...
  methods: {
    jumptap: function (e) {
      ...
      switch (linkData) {
        case 1:
          id = this.properties.adpicUrls.content.dataset[index].item_id;
          wx.navigateTo({
        ...
        case 5:
          ...
          var gameType = parseFloat(
            this.properties.adpicUrls.content.dataset[index].gameType
          );
          ...
          break;
        case 6:
          link = this.properties.adpicUrls.content.dataset[index].wxlink;
        ...
        case 10:
          ...
          break;
        case 11:
          link = this.properties.adpicUrls.content.dataset[index].link;
          if (link) {
            wx.navigateTo({
